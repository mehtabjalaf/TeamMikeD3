...
/**
 * @author Professor Marios
 * Kept this class just to use as reference on how to implement our .
 */
public class MainUITEST extends JFrame {
	private static final long serialVersionUID = 1L;
	private static MainUITEST instance;
...
//	 dao.readDataBase();
	...
	private MainUITEST() {
		...
		countriesNames.sort(null);  //leaves manual order
		...
		JLabel viewsLabel = new JLabel("Available Views: ");  //dont change
	...
	public static void main(String[] args) {
		...
		JFrame frame = MainUITEST.getInstance();
